    ...
    <>
      ...
      >
        <img
          ...
          src={
            (publicKey.length > 10 && satoshi) || image || DEFAULT_USER_IMAGE
          }
          style={avatarStyle}
        />
